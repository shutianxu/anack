...
def read_data_mysql(cur,atable):
...
'''
cur = Connect_sql()
result_yinli = read_data_mysql(cur,"result_yinli")
result_yingyun = read_data_mysql(cur,"result_yingyun")
result_chengzhang = read_data_mysql(cur,"result_chengzhang")
result_changzhai = read_data_mysql(cur,"result_changzhai")
result_xianjin = read_data_mysql(cur,"result_xianjin")

df_final = read_data_mysql(cur,"target")
